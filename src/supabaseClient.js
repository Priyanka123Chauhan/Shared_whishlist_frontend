...
const DATABASE_URL = "postgresql://postgres:Pdc!!123@db.ehgnkwmrtbfwzzebvvqm.supabase.co:5432/postgres"

export const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, DATABASE_URL);
